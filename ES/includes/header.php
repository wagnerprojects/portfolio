  ...
  <div class="cbp-af-inner">
    ...
    <nav id="nav" role="navigation">
      <ul id="menu">
        ...
        <li role="menuitem"><a href="#about" title="Sobre Dev">Sobre</a><span class="sep">/</span></li>
        <li role="menuitem"><a href="#jobs" title="Trabajo Recientes">Trabajos </a><span class="sep">/</span></li>
        <li role="menuitem"><a href="#skills" title="Habilidades">Skills</a><span class="sep">/</span></li>
        <li role="menuitem"><a href="#footer" title="Contatar-me">Contacto</a></li>
      </ul>
    </nav>
  </div>
  <!-- end .cbp-af-inner-->
